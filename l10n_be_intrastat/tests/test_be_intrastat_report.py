...
class TestBEIntrastatReport(TestAccountReportsCommon):
    ...
    def setUpClass(cls, chart_template_ref='be_comp'):
        ...
        # This tree represents the export with both kinds of report (the extended version)
    ...
    def test_full_export(self):
        ...
        # Both report should be present, but they should be absent of items (until we post)
