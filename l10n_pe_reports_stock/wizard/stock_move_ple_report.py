...
class StockMovePleReport(models.TransientModel):
    ...
    _description = 'Wizard to generate Stock Move PLE report for PE'
    ...
    date_from = fields.Date(
        required=True,
        help="Choose a date from to get the PLE report at that date",
    )
    date_to = fields.Date(
        required=True,
        help="Choose a date to get the PLE report at that date",
    )
