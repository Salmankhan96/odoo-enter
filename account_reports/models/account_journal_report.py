...
class JournalReportCustomHandler(models.AbstractModel):
    ...
    def _get_generic_tax_report_options(self, options, data):
        """
        Return an option dictionnary set to fetch the report with the parameters needed for this journal.
        The important bits are the journals, date, and fetch the generic tax report that contains all taxes.
