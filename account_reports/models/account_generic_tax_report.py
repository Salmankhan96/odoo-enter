...
class AccountTaxReportHandler(models.AbstractModel):
    ...
    # This model is needed for the Closing Entry button to be available for all report, including the generic one
    # With this, custom tax report don't need to inherit from the generic tax report
