...
class AccountMoveLine(models.Model):
    ...
    def _where_calc(self, domain, active_test=True):
        """ In case of cash basis for report, we need to shadow the table account_move_line to get amounts
        based on cash.
        We also need to get the analytic amounts in the table if we have the analytic grouping on report.
        """
