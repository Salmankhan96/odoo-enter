...
class AccountArVatLine(models.Model):
    """ Base model for new Argentine VAT report. The idea is that these lines have all the necessary data and which any
    changes in odoo, this ones will be taken for this cube and then no changes will be needed in the report that use
